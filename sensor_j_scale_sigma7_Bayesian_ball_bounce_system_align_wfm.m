...
Sigmadt=normrnd(1e-9,1e-10);
sdt(1)=Sigmadt;
LcurrHyperPrior = log(normpdf(1e-9,1e-10));
...
for k = 2:Nm   
    ...
    Sigmadt_prop=normrnd(1e-9,1e-10);
    LPropHyperPrior = log(normpdf(Sigmadt_prop,1e-9,1e-10));
...
save(['MCMC_4para_scale_sigma_sensor_' num2str(j) '_PpickAIC1bc_7.mat'],'v0','a','omega_s','varepsilon','sdt')
toc